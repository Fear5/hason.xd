...
git clone https://github.com/Fear5/hason.xd.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf hason.xd && rm -rf .telegram-cli && git clone https://github.com/Fear5/hason.xd.git && cd hason.xd && ./launch.sh install && ./launch.sh
~~~~~
